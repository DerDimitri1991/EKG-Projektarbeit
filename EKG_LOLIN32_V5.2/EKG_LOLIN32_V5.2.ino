...
#define MQTT_BROKER "192.168.178.40" // Pi 4_V2
...
void setup() {
    ...
    ads.setDataRate(RATE_ADS1115_475SPS); // Run faster so the process isn’t blocked. Result is ~250 Hz
    ads.startADCReading(ADS1X15_REG_CONFIG_MUX_SINGLE_0, true); // start on A0
...
// Send this ECG sample immediately
#ifdef ENABLE_WIFI_MQTT
String payload = "{";
